<script>
  ...
  $: steps = [
    ...
    <br><br>
    <p>
      From the below dropdown menu, choose a number of iterations to simulate the Monty Hall Problem. This will summarize the results for n iterations of the Monty Hall Problem. 
    </p>
    `,
